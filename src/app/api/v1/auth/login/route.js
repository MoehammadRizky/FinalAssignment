...
export async function POST(req) {
  ...
  try {
    ...
    // Jika user masih belum verifikasi, kirim pesan error
    ...
    // Jika user masih tidak ditemukan, kirim pesan error
    if (!findUser) {
    ...
    const res = NextResponse.json({ data: payload, message: "Login success!" }, { status: 200 });
